...
$meta=[
  'title'     => 'VTC Alzonne — Chauffeur Privé AUDE VTC | Tarif fixe dès 25€',
  'desc'      => 'Chauffeur privé VTC à Alzonne (Aude) — transferts depuis Alzonne vers les aéroports et gares. Tarif fixe dès 25€, Mercedes hybride.',
  'canonical' => 'https://www.audevtc.fr/villes/vtc-alzonne.php',
];
include '../includes/header.php';
include '../includes/icons.php';
$faq_ville=[
  ['Quel est le tarif VTC depuis Alzonne ?', 'Dès 25€ pour le trajet Alzonne – Carcassonne Airport. Tarif fixe, bagages inclus.'],
  ['AUDE VTC couvre-t-il Alzonne sans frais de déplacement ?', 'Oui. Alzonne est dans la zone de prise en charge gratuite d\'AUDE VTC (rayon 20 km autour de Carcassonne).'],
  ['Peut-on réserver un VTC Alzonne – Toulouse Blagnac ?', 'Oui. Environ 100 km depuis Alzonne. Tarif fixe sur devis gratuit.'],
  ['Y a-t-il un chauffeur privé disponible le week-end à Alzonne ?', 'Oui. Disponible 7j/7, week-ends et jours fériés inclus, sans majoration.'],
];
?>
<main style="padding-top:160px;">
  <section style="position:relative;padding:var(--s12) 0;background:var(--noir-2);overflow:hidden;">
    ...
    <div class="container" style="position:relative;">
      <span class="eyebrow">Chauffeur Privé · Aude · Dès 25€</span>
      <span class="gold-line"></span>
      <h1 class="section-title">VTC <span>Alzonne</span></h1>
      <p class="lead">Alzonne, commune de l'Aude à deux pas de Carcassonne, est desservie par AUDE VTC pour vos transferts aéroports et gares. Prise en charge à domicile, tarif fixe, confort premium.</p>
  ...
  <section class="section">
    <div class="container">
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:var(--s3);margin-bottom:var(--s8);">
        <?php foreach([['Tarif dès','25 €','Depuis Alzonne'],['Distance','~15 km','de Carcassonne'],['Durée','~15 min','Trajet estimé'],['Disponible','24h/7j','Sans majoration']] as $info): ?>
  ...
  <section class="section section--dark">
    <div class="container" style="max-width:860px;margin-inline:auto;">
      <div class="reveal" style="margin-bottom:var(--s4);">
        <span class="eyebrow">Votre chauffeur à Alzonne</span>
        <span class="gold-line"></span>
        <h2 class="section-title">AUDE VTC <span>à Alzonne</span></h2>
      </div>
      <p class="reveal" style="color:var(--gris-1);line-height:1.8;font-size:.95rem;">À 15 km au nord-ouest de Carcassonne, Alzonne offre un accès rapide à l'aéroport de Carcassonne (CCF) en moins de 20 minutes. AUDE VTC assure la prise en charge sans frais de déplacement supplémentaires.</p>
  ...
  <section class="section">
    <div class="container" style="max-width:800px;margin-inline:auto;">
      <div class="reveal" style="margin-bottom:var(--s6);">
        ...
        <span class="gold-line"></span>
        <h2 class="section-title">VTC <span>Alzonne</span></h2>
      </div>
  ...
  <section style="background:var(--or);padding:var(--s8) 0;">
    <div class="container" style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:var(--s4);">
      <div>
        <h2 style="font-family:var(--font-display);font-size:2rem;color:var(--noir);">Votre chauffeur à Alzonne</h2>
...
<section class="section section--dark">
  <div class="container" style="max-width:800px;margin-inline:auto;">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:var(--s2);margin-top:var(--s4);">
      ...
      <a href="/tourisme/cite-carcassonne.php" style="display:block;background:rgba(201,168,76,.05);border:1px solid rgba(201,168,76,.12);border-radius:var(--radius-lg);padding:var(--s2) var(--s3);text-decoration:none;color:var(--or);font-size:.88rem;text-align:center;" onmouseover="this.style.borderColor='rgba(201,168,76,.4)'" onmouseout="this.style.borderColor='rgba(201,168,76,.12)'">Cité Carcassonne →</a>
