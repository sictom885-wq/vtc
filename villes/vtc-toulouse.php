...
$meta=['title'=>'VTC Toulouse — Chauffeur Privé AUDE VTC | Tarif fixe dès 95€','desc'=>'Chauffeur privé VTC à Toulouse — transferts aéroport, gare Matabiau et tourisme depuis Toulouse. Tarif fixe dès 95€, Mercedes hybride.','canonical'=>'https://www.audevtc.fr/villes/vtc-toulouse.php'];
include '../includes/header.php';
include '../includes/icons.php';
$faq_ville=[
  ['Quel est le tarif VTC Carcassonne – Toulouse ?', '95€ fixe pour le trajet Carcassonne – Toulouse (gare ou adresse en ville). Tarif garanti à la réservation.'],
  ['AUDE VTC peut-il me conduire à Toulouse Blagnac ?', 'Oui. Le tarif vers l\'aéroport Toulouse Blagnac (TLS) est également de 95€ fixe depuis Carcassonne.'],
  ['Peut-on réserver un VTC Toulouse – Carcassonne ?', 'Oui. AUDE VTC assure aussi le trajet retour Toulouse → Carcassonne, au même tarif.'],
  ['Y a-t-il un VTC depuis Toulouse le week-end ?', 'Oui. Disponible 7j/7 sans majoration week-end.'],
];
?>
<main style="padding-top:160px;">
  <section style="position:relative;padding:var(--s12) 0;background:var(--noir-2);overflow:hidden;">
    ...
    <div class="container" style="position:relative;">
      <span class="eyebrow">Chauffeur Privé · Haute-Garonne · Dès 95€</span>
      <span class="gold-line"></span>
      <h1 class="section-title">VTC <span>Toulouse</span></h1>
      <p class="lead">Toulouse, capitale de l'Occitanie, est desservie par AUDE VTC pour tous vos transferts privés. Depuis Carcassonne, Michel Richard vous conduit à Toulouse Matabiau, Toulouse Blagnac, votre hôtel ou votre entreprise.</p>
  ...
  <section class="section">
    <div class="container">
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:var(--s3);margin-bottom:var(--s8);">
        <?php foreach([['Tarif dès','95 €','Depuis Toulouse'],['Distance','~85 km','de Carcassonne'],['Durée','~1h','Trajet estimé'],['Disponible','24h/7j','Sans majoration']] as $info): ?>
  ...
  <section class="section section--dark">
    <div class="container" style="max-width:860px;margin-inline:auto;">
      <div class="reveal" style="margin-bottom:var(--s4);">
        <span class="eyebrow">Votre chauffeur à Toulouse</span>
        <span class="gold-line"></span>
        <h2 class="section-title">AUDE VTC <span>à Toulouse</span></h2>
      </div>
      <p class="reveal" style="color:var(--gris-1);line-height:1.8;font-size:.95rem;">À 85 km de Carcassonne via l'A61, Toulouse est la métropole de référence du Grand Sud. AUDE VTC assure la connexion depuis l'Aude vers tous les quartiers toulousains, la gare Matabiau et l'aéroport Blagnac en un seul trajet.</p>
    </div>
  </section>
  <section class="section">
    <div class="container" style="max-width:800px;margin-inline:auto;">
      <div class="reveal" style="margin-bottom:var(--s6);">
        ...
        <span class="gold-line"></span>
        <h2 class="section-title">VTC <span>Toulouse</span></h2>
      </div>
  ...
  <section style="background:var(--or);padding:var(--s8) 0;">
    <div class="container" style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:var(--s4);">
      <div>
        <h2 style="font-family:var(--font-display);font-size:2rem;color:var(--noir);">Votre chauffeur à Toulouse</h2>
