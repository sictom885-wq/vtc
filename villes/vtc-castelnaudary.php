...
$meta=[
  'title'     => 'VTC Castelnaudary — Chauffeur Privé AUDE VTC | Tarif fixe dès 50€',
  'desc'      => 'Chauffeur privé VTC à Castelnaudary — transferts aéroport, gare et événements. Tarif fixe dès 50€, Mercedes hybride, disponible 24h/7j.',
  'canonical' => 'https://www.audevtc.fr/villes/vtc-castelnaudary.php',
];
include '../includes/header.php';
include '../includes/icons.php';
$faq_ville=[
  ['Quel est le tarif VTC Castelnaudary – Toulouse Blagnac ?', 'Environ 110€ pour le trajet Castelnaudary – Toulouse Blagnac (~55 km). Tarif fixe sur devis gratuit.'],
  ['AUDE VTC dessert-il la gare de Castelnaudary ?', 'Oui. Prise en charge en gare de Castelnaudary avec panneau nominatif. Suivi SNCF en temps réel.'],
  ['Y a-t-il un VTC pour les événements à Castelnaudary ?', 'Oui. Mariages, séminaires, soirées entreprise : AUDE VTC assure le transport depuis et vers Castelnaudary.'],
  ['Peut-on réserver un VTC Castelnaudary – Carcassonne ?', 'Oui. Dès 50€ pour le trajet Castelnaudary – Carcassonne (45 km). Confirmation sous 2h.'],
];
?>
<main style="padding-top:160px;">
  <section style="position:relative;padding:var(--s12) 0;background:var(--noir-2);overflow:hidden;">
    ...
    <div class="container" style="position:relative;">
      ...
      <h1 class="section-title">VTC <span>Castelnaudary</span></h1>
      <p class="lead">Castelnaudary, capitale mondiale du cassoulet et porte du Lauragais, est desservie par AUDE VTC pour tous vos besoins de transport privé. Transferts aéroports, gares, mariages, séminaires.</p>
  ...
  <section class="section">
    <div class="container">
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:var(--s3);margin-bottom:var(--s8);">
        <?php foreach([['Tarif dès','50 €','Depuis Castelnaudary'],['Distance','~45 km','de Carcassonne'],['Durée','~35 min','Trajet estimé'],['Disponible','24h/7j','Sans majoration']] as $info): ?>
  ...
  <section class="section section--dark">
    <div class="container" style="max-width:860px;margin-inline:auto;">
      <div class="reveal" style="margin-bottom:var(--s4);">
        <span class="eyebrow">Votre chauffeur à Castelnaudary</span>
        <span class="gold-line"></span>
        <h2 class="section-title">AUDE VTC <span>à Castelnaudary</span></h2>
      </div>
      <p class="reveal" style="color:var(--gris-1);line-height:1.8;font-size:.95rem;">Située à 45 km à l'ouest de Carcassonne sur l'A61, Castelnaudary est une plaque tournante du Lauragais. AUDE VTC assure les transferts depuis Castelnaudary vers Toulouse Blagnac (~55 km), Carcassonne Airport (~50 km) et les gares TGV.</p>
  ...
  <section class="section">
    <div class="container" style="max-width:800px;margin-inline:auto;">
      <div class="reveal" style="margin-bottom:var(--s6);">
        ...
        <span class="gold-line"></span>
        <h2 class="section-title">VTC <span>Castelnaudary</span></h2>
      </div>
  ...
  <section style="background:var(--or);padding:var(--s8) 0;">
    <div class="container" style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:var(--s4);">
      <div>
        <h2 style="font-family:var(--font-display);font-size:2rem;color:var(--noir);">Votre chauffeur à Castelnaudary</h2>
