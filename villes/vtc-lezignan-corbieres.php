...
$meta=[
  'title'     => 'VTC Lézignan-Corbières — Chauffeur Privé AUDE VTC | Tarif fixe dès 50€',
  'desc'      => 'Chauffeur privé VTC à Lézignan-Corbières — transferts aéroport et gare depuis Lézignan. Tarif fixe dès 50€, Mercedes hybride.',
  'canonical' => 'https://www.audevtc.fr/villes/vtc-lezignan-corbieres.php',
];
include '../includes/header.php';
include '../includes/icons.php';
$faq_ville=[
  ['Quel est le tarif VTC Lézignan – Carcassonne ?', 'Dès 50€ pour le trajet Lézignan-Corbières – Carcassonne (40 km). Tarif fixe garanti.'],
  ['AUDE VTC propose-t-il des circuits viticoles depuis Lézignan ?', 'Oui. Circuits dans les Corbières et le Minervois au départ de Lézignan sur demande.'],
  ['Peut-on rejoindre l\'aéroport de Perpignan depuis Lézignan ?', 'Oui. Lézignan – Perpignan Airport (PGF) : ~80 km, environ 1h. Devis gratuit.'],
  ['Y a-t-il un VTC disponible tôt le matin à Lézignan ?', 'Oui. AUDE VTC est disponible 24h/24, y compris pour les départs avant 6h du matin.'],
];
?>
<main style="padding-top:160px;">
  <section style="position:relative;padding:var(--s12) 0;background:var(--noir-2);overflow:hidden;">
    ...
    <div class="container" style="position:relative;">
      <span class="eyebrow">Chauffeur Privé · Aude · Dès 50€</span>
      <span class="gold-line"></span>
      <h1 class="section-title">VTC <span>Lézignan-Corbières</span></h1>
      <p class="lead">Au cœur des Corbières, Lézignan-Corbières est desservie par AUDE VTC pour tous vos transferts privés. Aéroports, gares, tourisme viticole : Michel Richard assure votre transport avec ponctualité et discrétion.</p>
  ...
  <section class="section">
    <div class="container">
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:var(--s3);margin-bottom:var(--s8);">
        <?php foreach([['Tarif dès','50 €','Depuis Lézignan-Corbières'],['Distance','~40 km','de Carcassonne'],['Durée','~30 min','Trajet estimé'],['Disponible','24h/7j','Sans majoration']] as $info): ?>
  ...
  <section class="section section--dark">
    <div class="container" style="max-width:860px;margin-inline:auto;">
      <div class="reveal" style="margin-bottom:var(--s4);">
        <span class="eyebrow">Votre chauffeur à Lézignan-Corbières</span>
        <span class="gold-line"></span>
        <h2 class="section-title">AUDE VTC <span>à Lézignan-Corbières</span></h2>
      </div>
      <p class="reveal" style="color:var(--gris-1);line-height:1.8;font-size:.95rem;">Lézignan-Corbières, à 40 km de Carcassonne via l'A61, est au carrefour des Corbières et du Minervois. AUDE VTC dessert la ville et les domaines viticoles environnants pour des transferts ou circuits œnotouristiques.</p>
  ...
  <section class="section">
    <div class="container" style="max-width:800px;margin-inline:auto;">
      <div class="reveal" style="margin-bottom:var(--s6);">
        ...
        <span class="gold-line"></span>
        <h2 class="section-title">VTC <span>Lézignan-Corbières</span></h2>
      </div>
  ...
  <section style="background:var(--or);padding:var(--s8) 0;">
    <div class="container" style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:var(--s4);">
      <div>
        <h2 style="font-family:var(--font-display);font-size:2rem;color:var(--noir);">Votre chauffeur à Lézignan-Corbières</h2>
...
<section class="section section--dark">
  <div class="container" style="max-width:800px;margin-inline:auto;">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:var(--s2);margin-top:var(--s4);">
      ...
      <a href="/tourisme/abbaye-fontfroide.php" style="display:block;background:rgba(201,168,76,.05);border:1px solid rgba(201,168,76,.12);border-radius:var(--radius-lg);padding:var(--s2) var(--s3);text-decoration:none;color:var(--or);font-size:.88rem;text-align:center;" onmouseover="this.style.borderColor='rgba(201,168,76,.4)'" onmouseout="this.style.borderColor='rgba(201,168,76,.12)'">Fontfroide →</a>
