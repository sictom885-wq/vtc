...
$meta=['title'=>'VTC Béziers — Chauffeur Privé AUDE VTC | Tarif fixe dès 90€','desc'=>'Chauffeur privé VTC à Béziers (Hérault) — transferts depuis Béziers vers Carcassonne et les aéroports. Tarif fixe dès 90€, Mercedes hybride.','canonical'=>'https://www.audevtc.fr/villes/vtc-beziers.php'];
include '../includes/header.php';
include '../includes/icons.php';
$faq_ville=[
  ['Quel est le tarif VTC Carcassonne – Béziers ?', 'Dès 90€ pour le trajet Carcassonne – Béziers (~85 km). Tarif fixe garanti.'],
  ['AUDE VTC dessert-il l\'aéroport Béziers Cap d\'Agde ?', 'Oui. Tarif fixe 110€ depuis Carcassonne vers l\'aéroport Béziers (BZR).'],
  ['Peut-on faire le Canal du Midi depuis Béziers en VTC ?', 'Oui. Circuit Canal du Midi – Béziers – Carcassonne disponible sur demande.'],
  ['Y a-t-il un VTC depuis Béziers le soir ?', 'Oui. AUDE VTC est disponible 24h/24, y compris les retours de soirée depuis Béziers.'],
];
?>
<main style="padding-top:160px;">
  <section style="position:relative;padding:var(--s12) 0;background:var(--noir-2);overflow:hidden;">
    ...
    <div class="container" style="position:relative;">
      <span class="eyebrow">Chauffeur Privé · Hérault · Dès 90€</span>
      <span class="gold-line"></span>
      <h1 class="section-title">VTC <span>Béziers</span></h1>
      <p class="lead">Béziers, cité viticole du Languedoc, est desservie par AUDE VTC pour tous vos transferts. Depuis Carcassonne, Michel Richard vous conduit à Béziers, à l'aéroport Cap d'Agde ou partout dans l'Hérault.</p>
  ...
  <section class="section">
    <div class="container">
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:var(--s3);margin-bottom:var(--s8);">
        <?php foreach([['Tarif dès','90 €','Depuis Béziers'],['Distance','~85 km','de Carcassonne'],['Durée','~50 min','Trajet estimé'],['Disponible','24h/7j','Sans majoration']] as $info): ?>
  ...
  <section class="section section--dark">
    <div class="container" style="max-width:860px;margin-inline:auto;">
      <div class="reveal" style="margin-bottom:var(--s4);">
        <span class="eyebrow">Votre chauffeur à Béziers</span>
        <span class="gold-line"></span>
        <h2 class="section-title">AUDE VTC <span>à Béziers</span></h2>
      </div>
      <p class="reveal" style="color:var(--gris-1);line-height:1.8;font-size:.95rem;">À 85 km de Carcassonne via l'A61 et l'A9, Béziers est la porte de l'Hérault depuis l'Aude. AUDE VTC assure les transferts Carcassonne – Béziers pour les voyageurs d'affaires, les familles et les touristes du Canal du Midi.</p>
    </div>
  </section>
  <section class="section">
    <div class="container" style="max-width:800px;margin-inline:auto;">
      <div class="reveal" style="margin-bottom:var(--s6);">
        ...
        <span class="gold-line"></span>
        <h2 class="section-title">VTC <span>Béziers</span></h2>
      </div>
  ...
  <section style="background:var(--or);padding:var(--s8) 0;">
    <div class="container" style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:var(--s4);">
      <div>
        <h2 style="font-family:var(--font-display);font-size:2rem;color:var(--noir);">Votre chauffeur à Béziers</h2>
