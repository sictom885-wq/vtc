...
$meta = [
  ...
  'desc'      => $t['pp_meta_desc'],
  'canonical' => 'https://www.audevtc.fr/de/prestations.php',
];
include '../includes/header.php';
include '../includes/icons.php';

$prestations = [
  ['icon'=>'plane','titre'=>$t['pp_aero_title'],'desc'=>$t['pp_aero_desc'],'points'=>[$t['pp_aero_p1'],$t['pp_aero_p2'],$t['pp_aero_p3']],'url'=>'de/transferts-aeroport.php','cta'=>$t['pp_aero_cta']],
  ['icon'=>'train','titre'=>$t['pp_gare_title'],'desc'=>$t['pp_gare_desc'],'points'=>[$t['pp_gare_p1'],$t['pp_gare_p2'],$t['pp_gare_p3']],'url'=>'de/transferts-gare.php','cta'=>$t['pp_gare_cta']],
  ['icon'=>'castle','titre'=>$t['pp_tour_title'],'desc'=>$t['pp_tour_desc'],'points'=>[$t['pp_tour_p1'],$t['pp_tour_p2'],$t['pp_tour_p3']],'url'=>'de/tourisme-occitanie.php','cta'=>$t['pp_tour_cta']],
  ['icon'=>'heart','titre'=>$t['pp_evt_title'],'desc'=>$t['pp_evt_desc'],'points'=>[$t['pp_evt_p1'],$t['pp_evt_p2'],$t['pp_evt_p3']],'url'=>'de/evenements.php','cta'=>$t['pp_evt_cta']],
];
$engagements = [
  ...
  <section style="background:var(--or);padding:var(--s8) 0;">
    <div class="container" style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:var(--s4);">
      ...
      <div style="display:flex;gap:var(--s2);">
        <a href="/de/contact.php" class="btn" style="background:var(--noir);color:var(--blanc);"><?= $t['pp_cta_devis'] ?></a>
