...
$t = vtc_t('de');
$meta = ['title'=>$t['ev_meta_title'],'desc'=>$t['ev_meta_desc'],'canonical'=>'https://www.audevtc.fr/de/evenements.php'];
...
<main style="padding-top:160px;">
    ...
    <div class="container">
      ...
      <div class="prestations-grid" style="margin-top:var(--s6);">
        ...
        <div class="presta-card reveal reveal-delay-<?= $i+1 ?>"><div class="presta-body">
          ...
          <a href="/de/contact.php" class="presta-link"><?= $t['ev_cta_quote'] ?> <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg></a>
        </div></div>
        <?php endforeach; ?>
      </div>
    </div>
  ...
  <section class="section section--dark" id="tarifs-dispo">
    <div class="container">
      ...
      <div style="text-align:center;margin-top:var(--s6);"><a href="/de/contact.php" class="btn btn-primary"><?= $t['ev_cta_reserve'] ?></a></div>
    </div>
  </section>
</main>
