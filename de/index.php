...
$meta = [
  ...
  'canonical' => 'https://www.audevtc.fr/de/',
];
...
<section id="hero">
  ...
  <div class="container">
    <div class="hero-content">
      ...
      <div class="hero-ctas">
        <a href="/de/contact.php" class="btn btn-primary">
...
<section id="reservation">
  <div class="container">
    <div class="form-resa reveal">
      ...
      <form id="form-reservation" action="/de/contact.php" method="POST">
        <div class="form-grid">
...
<section id="prestations" class="section section--dark">
  <div class="container">
    ...
    <div class="prestations-grid">
      <?php
      $prests = [
        ['aeroport','prest_aeroport_title','prest_aeroport_desc',['Carcassonne Airport','Toulouse Blagnac','Montpellier · Perpignan','Bordeaux Mérignac'],'/de/airport-transfers.php','M17.8 19.2 16 11l3.5-3.5C21 6 21 4 19 4c-1 0-1.5.5-3.5 2.5L8 8 1.2 6.2C.7 6.1.3 6.6.5 7.1l2 5.3a1 1 0 0 0 .7.6l4.3 1-1 3.3a1 1 0 0 0 1.3 1.3l3.3-1 1 4.3a1 1 0 0 0 .6.7l5.3 2c.5.2 1-.2.9-.7Z'],
        ['gare','prest_gare_title','prest_gare_desc',['Carcassonne & Castelnaudary','Toulouse Matabiau','Montpellier · Sète · Béziers'],'/de/train-transfers.php','M 4 3 h 16 a 2 2 0 0 1 2 2 v 10 a 2 2 0 0 1-2 2 H 4 a 2 2 0 0 1-2-2 V 5 a 2 2 0 0 1 2-2 z M 4 11 h 16 M 12 3 v 8 M 8 19 l-2 3 M 18 22 l-2-3'],
        ['tourisme','prest_tourisme_title','prest_tourisme_desc',['Custom tourist circuits','Weddings & baptisms','Congresses & seminars','Day hire'],'/de/tourism-occitanie.php','M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Zm-5 0a3 3 0 1 1-6 0 3 3 0 0 1 6 0z'],
      ];
...
<section id="tarifs-dispo" class="section">
  <div class="container">
    ...
    <div style="text-align:center;margin-top:var(--s6);"><a href="/de/rates.php" class="btn btn-outline"><?= $t['tarifs_voir_tout'] ?></a></div>
  </div>
</section>
