      ...
      <div class="form-resa reveal">
        <?php if($sent): ?>
          <div style="text-align:center;padding:var(--s8);">
            ...
            <a href="/de/" class="btn btn-primary" style="margin-top:var(--s4);"><?= $t['contact_back'] ?></a>
          </div>
        <?php else: ?>
          ...
          <div class="form-resa-header"><span class="eyebrow">Buchungsformular</span><h2 style="font-size:1.8rem;margin-bottom:var(--s1);">Ihre Anfrage</h2></div>
          <form method="POST" action="/de/contact.php">
            <div class="form-grid">
