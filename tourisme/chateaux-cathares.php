...
$meta=['title'=>'VTC Châteaux Cathares depuis Carcassonne — Circuit privé AUDE VTC','desc'=>'Circuit VTC privé vers les châteaux cathares depuis Carcassonne : Peyrepertuse, Quéribus, Puilaurens. Sur mesure, trilingue, Mercedes hybride.','canonical'=>'https://www.audevtc.fr/tourisme/chateaux-cathares.php'];
include '../includes/header.php';
include '../includes/icons.php';
$faq_t=[
  ['Combien de châteaux cathares peut-on visiter en une journée ?', '2 à 3 châteaux sont raisonnables en une journée depuis Carcassonne, selon votre rythme de visite.'],
  ['Peyrepertuse ou Quéribus : lequel choisir ?', 'Peyrepertuse est le plus grand et le plus impressionnant. Quéribus offre le panorama le plus spectaculaire. L\'idéal est de faire les deux.'],
  ['Le circuit est-il adapté aux enfants ?', 'Oui, avec des ajustements. Peyrepertuse nécessite 20-30 min de marche. Michel Richard sélectionne les sites selon l\'âge.'],
  ['Faut-il réserver les entrées à l\'avance ?', 'En juillet-août, oui. Peyrepertuse et Quéribus peuvent être complets. Michel Richard peut vous conseiller.'],
];
?>
<main style="padding-top:160px;">
  <section style="position:relative;padding:var(--s12) 0;background:var(--noir-2);overflow:hidden;">
    ...
    <div class="container" style="position:relative;">
      <span class="eyebrow">Tourisme · Histoire · Corbières</span>
      <span class="gold-line"></span>
      <h1 class="section-title">VTC <span>Châteaux Cathares</span></h1>
      <p class="lead">Peyrepertuse, Quéribus, Puilaurens, Aguilar : les châteaux cathares des Corbières et des Pyrénées audoises sont parmi les sites médiévaux les plus spectaculaires de France. AUDE VTC vous y conduit en circuit privé, à votre rythme.</p>
  ...
  <section class="section section--dark">
    <div class="container" style="max-width:860px;margin-inline:auto;">
      <div class="reveal" style="margin-bottom:var(--s4);">
        ...
        <span class="gold-line"></span>
        <h2 class="section-title">Votre chauffeur <span>pour Châteaux Cathares</span></h2>
      </div>
      <p class="reveal" style="color:var(--gris-1);line-height:1.8;font-size:.95rem;">Les routes vers les châteaux cathares sont étroites et sinueuses. Michel Richard les connaît parfaitement. Laissez-le conduire pendant que vous profitez des panoramas sur les Corbières, le Fenouillèdes et les Pyrénées.</p>
  ...
  <section class="section">
    <div class="container" style="max-width:800px;margin-inline:auto;">
      <div class="reveal" style="margin-bottom:var(--s6);">
        ...
        <span class="gold-line"></span>
        <h2 class="section-title">VTC <span>Châteaux Cathares</span></h2>
      </div>
  ...
  <section style="background:var(--or);padding:var(--s8) 0;">
    <div class="container" style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:var(--s4);">
      <div>
        <h2 style="font-family:var(--font-display);font-size:2rem;color:var(--noir);">Visiter Châteaux Cathares ?</h2>
