...
$faq_t=[
  ['Quel est le tarif VTC Carcassonne – Gouffre de Cabrespine ?', 'Environ 40€ pour le trajet Carcassonne – Cabrespine (30 km). Tarif fixe sur devis.'],
  ['La visite est-elle adaptée aux enfants ?', 'Oui. Le gouffre est accessible dès 4 ans. Prévoir des vêtements chauds (12°C en permanence).'],
  ['Michel Richard peut-il attendre pendant la visite ?', 'Oui. Mise à disposition possible. La visite dure environ 1h.'],
  ['Peut-on combiner Cabrespine et la Cité de Carcassonne ?', 'Oui. Un circuit matin Cabrespine + après-midi Cité est réalisable depuis Carcassonne.'],
];
?>
<main style="padding-top:160px;">
  <section style="position:relative;padding:var(--s12) 0;background:var(--noir-2);overflow:hidden;">
    ...
    <div class="container" style="position:relative;">
      <span class="eyebrow">Tourisme · Nature · Montagne Noire</span>
      <span class="gold-line"></span>
      <h1 class="section-title">VTC <span>Gouffre de Cabrespine</span></h1>
      <p class="lead">Le Gouffre de Cabrespine, l'un des plus grands gouffres souterrains d'Europe, offre un spectacle géologique unique dans la Montagne Noire. AUDE VTC vous y conduit depuis Carcassonne, idéal pour une sortie en famille.</p>
  ...
  <section class="section section--dark">
    <div class="container" style="max-width:860px;margin-inline:auto;">
      <div class="reveal" style="margin-bottom:var(--s4);">
        ...
        <span class="gold-line"></span>
        <h2 class="section-title">Votre chauffeur <span>pour Gouffre de Cabrespine</span></h2>
      </div>
      <p class="reveal" style="color:var(--gris-1);line-height:1.8;font-size:.95rem;">À 30 km de Carcassonne, le Gouffre de Cabrespine est accessible via des routes de montagne. La visite dure environ 1h. Michel Richard peut vous attendre sur place et vous proposer une halte dans les villages de la Montagne Noire au retour.</p>
  ...
  <section class="section">
    <div class="container" style="max-width:800px;margin-inline:auto;">
      <div class="reveal" style="margin-bottom:var(--s6);">
        ...
        <span class="gold-line"></span>
        <h2 class="section-title">VTC <span>Gouffre de Cabrespine</span></h2>
      </div>
  ...
  <section style="background:var(--or);padding:var(--s8) 0;">
    <div class="container" style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:var(--s4);">
      <div>
        <h2 style="font-family:var(--font-display);font-size:2rem;color:var(--noir);">Visiter Gouffre de Cabrespine ?</h2>
