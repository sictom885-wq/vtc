...
$meta=['title'=>'VTC Cité de Carcassonne — Transfert privé AUDE VTC | Dès 20€','desc'=>'Transfert VTC vers la Cité médiévale de Carcassonne. Dépôt à la porte Narbonnaise, tarif fixe dès 20€, disponible 24h/7j. Idéal familles et groupes.','canonical'=>'https://www.audevtc.fr/tourisme/cite-carcassonne.php'];
include '../includes/header.php';
include '../includes/icons.php';
$faq_t=[
  ['Où se fait le dépôt à la Cité de Carcassonne ?', 'À la porte Narbonnaise (entrée principale) ou à votre hébergement si vous logez dans les remparts.'],
  ['Quel est le tarif VTC depuis l\'aéroport de Carcassonne ?', 'Dès 25€ depuis l\'aéroport CCF vers la Cité. Tarif fixe, bagages inclus.'],
  ['AUDE VTC peut-il revenir me chercher après la visite ?', 'Oui. Michel Richard peut vous attendre ou revenir à l\'heure souhaitée. Précisez-le à la réservation.'],
  ['Y a-t-il un VTC disponible le soir à la Cité ?', 'Oui. Disponible 24h/24. Très pratique pour les spectacles nocturnes des Médiévales ou la Bastille (14 juillet).'],
];
?>
<main style="padding-top:160px;">
  <section style="position:relative;padding:var(--s12) 0;background:var(--noir-2);overflow:hidden;">
    ...
    <div class="container" style="position:relative;">
      <span class="eyebrow">Tourisme · Patrimoine UNESCO · Carcassonne</span>
      <span class="gold-line"></span>
      <h1 class="section-title">VTC <span>Cité de Carcassonne</span></h1>
      <p class="lead">La Cité de Carcassonne, classée au patrimoine mondial de l'UNESCO, est l'un des sites médiévaux les plus imposants d'Europe. AUDE VTC vous y conduit depuis votre hôtel, votre gîte ou l'aéroport, sans stress de stationnement.</p>
  ...
  <section class="section section--dark">
    <div class="container" style="max-width:860px;margin-inline:auto;">
      <div class="reveal" style="margin-bottom:var(--s4);">
        ...
        <span class="gold-line"></span>
        <h2 class="section-title">Votre chauffeur <span>pour Cité de Carcassonne</span></h2>
      </div>
      <p class="reveal" style="color:var(--gris-1);line-height:1.8;font-size:.95rem;">Depuis le centre-ville de Carcassonne, la Cité est à 2 km. Mais en haute saison, le stationnement est quasi impossible et les navettes bondées. Un VTC vous dépose directement à la porte Narbonnaise ou à votre hébergement dans les remparts.</p>
  ...
  <section class="section">
    <div class="container" style="max-width:800px;margin-inline:auto;">
      <div class="reveal" style="margin-bottom:var(--s6);">
        ...
        <span class="gold-line"></span>
        <h2 class="section-title">VTC <span>Cité de Carcassonne</span></h2>
      </div>
  ...
  <section style="background:var(--or);padding:var(--s8) 0;">
    <div class="container" style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:var(--s4);">
      <div>
        <h2 style="font-family:var(--font-display);font-size:2rem;color:var(--noir);">Visiter Cité de Carcassonne ?</h2>
