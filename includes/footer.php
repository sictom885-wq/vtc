    ...
    <div class="footer-grid">
      ...
      <div class="footer-brand">
        <a href="/<?= $prefix ?>" class="logo" aria-label="AUDE VTC — Accueil">
          <img src="/assets/images/logo-audevtc-lg.webp" alt="AUDE VTC — Chauffeur Privé Carcassonne" width="180" height="180" loading="lazy" decoding="async" style="display:block;">
        </a>
        <p class="footer-desc">
