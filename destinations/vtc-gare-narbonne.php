...
$meta=['title'=>'VTC Gare de Narbonne — Transfert privé AUDE VTC | Tarif fixe dès 65€','desc'=>'Transfert VTC depuis et vers la gare de Narbonne. Accueil sur quai, suivi SNCF en temps réel, tarif fixe dès 65€. Mercedes hybride.','canonical'=>'https://www.audevtc.fr/destinations/vtc-gare-narbonne.php'];
include '../includes/header.php';
include '../includes/icons.php';
$faq_dest=[
  ['Quel est le tarif VTC depuis la gare de Narbonne vers Carcassonne ?', 'Dès 65€ pour le trajet Narbonne → Carcassonne (60 km). Tarif fixe garanti.'],
  ['AUDE VTC surveille-t-il les retards SNCF à Narbonne ?', 'Oui. Votre chauffeur consulte les horaires SNCF en temps réel et s\'adapte sans frais.'],
  ['Peut-on rejoindre l\'aéroport de Perpignan depuis Narbonne ?', 'Oui. Narbonne – Perpignan Airport (PGF) : ~65 km, ~45 min. Devis gratuit.'],
  ['Y a-t-il un accueil nominatif à la gare de Narbonne ?', 'Oui. Michel Richard vous attend avec un panneau à votre nom dans le hall de la gare.'],
];
?>
<main style="padding-top:160px;">
  <section style="position:relative;padding:var(--s12) 0;background:var(--noir-2);overflow:hidden;">
    ...
    <div class="container" style="position:relative;">
      <span class="eyebrow">Transfert Gare · Narbonne · ~60 km</span>
      <span class="gold-line"></span>
      <h1 class="section-title">VTC <span>Gare de Narbonne</span></h1>
      <p class="lead">Prise en charge en gare de Narbonne avec panneau nominatif. Connexion vers Carcassonne, les aéroports et tout l'Aude. Tarif fixe, suivi SNCF temps réel.</p>
  ...
  <section class="section">
    <div class="container">
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:var(--s3);margin-bottom:var(--s8);">
        <?php foreach([['Tarif dès','65 €','Narbonne → Carcassonne'],['Distance','~60 km','De Carcassonne'],['Suivi','SNCF live','Retard inclus'],['Disponible','24h/7j','Sans majoration'],] as $info): ?>
      ...
      <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:var(--s3);">
        <?php foreach([['Accueil en gare de Narbonne','Panneau nominatif, aide aux bagages, prise en charge immédiate dès la sortie du train.'],['Suivi SNCF temps réel','Train retardé ? Votre chauffeur ajuste son heure d\'arrivée sans que vous ayez à appeler.'],['Connexion vers toute l\'Aude','Depuis Narbonne, AUDE VTC vous conduit à Carcassonne, vers les aéroports, les sites touristiques ou votre hôtel.'],] as $i=>$av): ?>
  ...
  <section class="section section--dark">
    <div class="container" style="max-width:860px;margin-inline:auto;">
      ...
      <p class="reveal" style="color:var(--gris-1);line-height:1.8;">La gare de Narbonne est un nœud ferroviaire majeur du Languedoc, sur la ligne Bordeaux–Marseille. AUDE VTC assure la correspondance vers Carcassonne et toute la région.</p>
    </div>
  </section>
  <section class="section">
    <div class="container" style="max-width:800px;margin-inline:auto;">
      <div class="reveal" style="margin-bottom:var(--s6);">
        ...
        <span class="gold-line"></span>
        <h2 class="section-title">VTC <span>Gare de Narbonne</span></h2>
      </div>
  ...
  <section class="section section--dark">
    <div class="container" style="max-width:800px;margin-inline:auto;">
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:var(--s2);margin-top:var(--s4);">
        ...
        <a href="/villes/vtc-narbonne.php" style="display:block;background:rgba(201,168,76,.05);border:1px solid rgba(201,168,76,.12);border-radius:var(--radius-lg);padding:var(--s2) var(--s3);text-decoration:none;color:var(--or);font-size:.88rem;text-align:center;transition:border-color var(--transition);" onmouseover="this.style.borderColor='rgba(201,168,76,.4)'" onmouseout="this.style.borderColor='rgba(201,168,76,.12)'">VTC Narbonne →</a>
  ...
  <section style="background:var(--or);padding:var(--s8) 0;">
    <div class="container" style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:var(--s4);">
      <div>
        <h2 style="font-family:var(--font-display);font-size:2rem;color:var(--noir);">Arrivée en gare de Narbonne ?</h2>
