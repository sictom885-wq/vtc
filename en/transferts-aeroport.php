...
$t = vtc_t('en');
$meta = ['title'=>$t['ta_meta_title'],'desc'=>$t['ta_meta_desc'],'canonical'=>'https://www.audevtc.fr/en/transferts-aeroport.php'];
...
<main style="padding-top:160px;">
  ...
  <section class="section section--dark">
    <div class="container">
      ...
      <div style="margin-top:var(--s6);text-align:center;"><a href="/en/contact.php" class="btn btn-primary"><?= $t['ta_cta_exact'] ?></a></div>
    </div>
  </section>
